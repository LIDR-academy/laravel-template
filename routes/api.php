...
// --- POSTS (read = public) ----------------------------------------------
// Refactored into the layered architecture: PostController -> Store/UpdatePostRequest
// -> PostService -> PostResource, with author-only writes enforced by PostPolicy.
